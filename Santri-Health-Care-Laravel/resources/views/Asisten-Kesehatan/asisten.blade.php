    ...
    <main id="page-content">
      ...
      <section class="z-20 relative pt-32 pb-16 px-6">
        <div class="container mx-auto text-center relative z-10">
          <h1 class="text-2xl md:text-5xl font-bold primary-color">Pilih Salah Satu Keluhan Anda.</h1>
          <h2 class="text-xl md:text-xl font-medium mb-6 primary-color">Kami bersedia memberikan solusi bagi gejala yang anda alami!</h2>
        </div>
      </section>
      
      <!-- Card Section -->
      <section class="z-20 relative py-16 px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Sakit Kepala</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Diare</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Sakit Perut</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Badan Pegal</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Sakit Gigi</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Mual</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Masalah Kulit</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Akibat kelelahan, kurang istirahat, atau perubahan cuaca.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
            ...
            <div class="asisten-card">
              ...
              <div class="asisten-content">
                <h3 class="text-3xl font-bold mb-4 text-center primary-color">Lainnya</h3>
                <p class="text-gray-600 mb-6 text-center flex-grow">Keluhan kesehatan lainnya yang tidak tercantum dalam list.</p>
                <a href="{{ route('asisten-kesehatan.detail') }}" class="asisten-button primary-color"> Lebih Lanjut... </a>
              </div>
            </div>
          </div>
